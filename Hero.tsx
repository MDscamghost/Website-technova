...
export default function Hero({ onShopNow }: HeroProps) {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon-blue/30 rounded-full blur-[128px] animate-pulse-slow" style={{ animationDelay: '1000ms' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-white/5 border border-white/10 text-neon-blue text-sm font-bold tracking-wider mb-6 backdrop-blur-sm" data-testid="text-hero-badge">
        ...
        <motion.h1
          ...
          className="text-6xl md:text-8xl lg:text-9xl font-display font-bold mb-8 tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-400 drop-shadow-2xl"
        ...
        >
          ...
          <button 
            className="px-8 py-4 rounded-full border border-white/20 hover:bg-white/10 transition-colors flex items-center gap-2 backdrop-blur-sm"
            data-testid="button-watch-keynote"
          >
      ...
      >
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="hsl(var(--neon-blue))" d="M44.7,-76.4C58.9,-69.2,71.8,-59.1,79.6,-46.3C87.4,-33.5,90.1,-18,88.5,-3.1C86.9,11.8,81,26.1,72.3,38.1C63.6,50.1,52.1,59.8,39.5,66.3C26.9,72.8,13.2,76.1,-0.5,77C-14.2,77.8,-28.7,76.2,-41.5,69.8C-54.3,63.4,-65.4,52.2,-73.6,39.3C-81.8,26.4,-87.1,11.8,-85.9,-2.3C-84.7,-16.4,-77,-31.3,-66.8,-42.8C-56.6,-54.3,-43.9,-62.4,-30.8,-70.2C-17.7,-78,-4.1,-85.5,5.4,-94.8L14.8,-104.1L44.7,-76.4Z" transform="translate(100 100)" />
        </svg>
      </motion.div>
    </div>
  );
